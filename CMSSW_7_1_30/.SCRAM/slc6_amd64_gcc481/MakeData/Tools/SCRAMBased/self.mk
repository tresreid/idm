...
SimG4CoreGenerators_EX_USE := $(foreach d, self  FWCore/ParameterSet FWCore/MessageLogger SimDataFormats/GeneratorProducts boost heppdt geant4core rootmath expat,$(if $($(d)_EX_FLAGS_NO_RECURSIVE_EXPORT),,$d))
...
GeneratorInterfaceCore_EX_USE := $(foreach d, self  FWCore/Concurrency FWCore/ServiceRegistry FWCore/Utilities FWCore/Framework SimDataFormats/GeneratorProducts GeneratorInterface/LHEInterface heppdt boost clhep lhapdf f77compiler,$(if $($(d)_EX_FLAGS_NO_RECURSIVE_EXPORT),,$d))
