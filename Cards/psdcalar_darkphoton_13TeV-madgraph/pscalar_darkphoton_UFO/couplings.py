...
GC_13 = Coupling(name = 'GC_13',
                 value = '-(ee*complex(0,1)*gnew)/3.',
                 order = {'QED':2})

GC_14 = Coupling(name = 'GC_14',
                 value = '(2*ee*complex(0,1)*gnew)/3.',
                 order = {'QED':2})

GC_15 = Coupling(name = 'GC_15',
                 value = '-(ee*complex(0,1)*gnew)',
                 order = {'QED':2})
...
GC_55 = Coupling(name = 'GC_55',
                 value = '-4.7*LamDarkMinv',
                 order = {'QED':1})

GC_56 = Coupling(name = 'GC_56',
                 value = '-1.27*LamDarkMinv',
                 order = {'QED':1})

GC_57 = Coupling(name = 'GC_57',
                 value = '-0.101*LamDarkMinv',
                 order = {'QED':1})

GC_58 = Coupling(name = 'GC_58',
                 value = '-0.00504*LamDarkMinv',
                 order = {'QED':1})

GC_59 = Coupling(name = 'GC_59',
                 value = '-0.00255*LamDarkMinv',
                 order = {'QED':1})

GC_60 = Coupling(name = 'GC_60',
                 value = '-(complex(0,1)*LamDarkPhoinv)',
                 order = {'QED':1})
