...
LamDarkMinv = Parameter(name = 'LamDarkMinv',
                        nature = 'external',
                        type = 'real',
                        value = 0.01,
                        texname = '\\text{LamDMinv}',
                        lhablock = 'CutoffDM',
                        lhacode = [ 1 ])

LamDarkPhoinv = Parameter(name = 'LamDarkPhoinv',
                          nature = 'external',
                          type = 'real',
                          value = 0.01,
                          texname = '\\text{LamDPinv}',
                          lhablock = 'CutoffDP',
                          lhacode = [ 1 ])

gnew = Parameter(name = 'gnew',
                 nature = 'external',
                 type = 'real',
                 value = 1,
                 texname = 'g_{\\text{new}}',
...
sw2 = Parameter(name = 'sw2',
                nature = 'internal',
                type = 'real',
                value = '1 - 0.00012022930132348414*MW**2',
                texname = '\\text{sw2}')
