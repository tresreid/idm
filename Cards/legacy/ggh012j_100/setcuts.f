...
c-do not apply cuts to these
         ...
         if (abs(idup(i,1,iproc)).eq.18) do_cuts(i)=.false.  ! no cuts on vt vt~
c         if (abs(idup(i,1,iproc)).eq.25) do_cuts(i)=.false.  ! no cuts on vt vt~
c-flavor-jets
...
c-neutrino's for missing et
         ...
         if (abs(idup(i,1,iproc)).eq.18) is_a_nu(i)=.true.  ! no cuts on vt vt~
c         if (abs(idup(i,1,iproc)).eq.25) is_a_nu(i)=.true.  ! no cuts on vt vt~
