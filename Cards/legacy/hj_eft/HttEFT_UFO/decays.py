...
Decay_H = Decay(name = 'Decay_H',
                particle = P.H,
                partial_widths = {(P.t,P.t__tilde__):'((3*MH**2*yt**2 - (9*cy*MH**2*yt**2)/2. - 12*MT**2*yt**2 + 18*cy*MT**2*yt**2 - (27*cy**2*MT**2*yt**2)/4. - (9*MH**2*yt**2*complexconjugate(cy))/2. + (27*cy*MH**2*yt**2*complexconjugate(cy))/4. + 18*MT**2*yt**2*complexconjugate(cy) - (27*cy*MT**2*yt**2*complexconjugate(cy))/2. - (27*MT**2*yt**2*complexconjugate(cy)**2)/4.)*cmath.sqrt(MH**4 - 4*MH**2*MT**2))/(16.*cmath.pi*abs(MH)**3)',
                                  (P.tp,P.tp__tilde__):'(((6*cg**2*MH**2*MTP**2)/vev**2 + (6*cgt**2*MH**2*MTP**2)/vev**2 - (24*cg**2*MTP**4)/vev**2)*cmath.sqrt(MH**4 - 4*MH**2*MTP**2))/(16.*cmath.pi*abs(MH)**3)',
