...
#./install.py --carddir Cards/tth012j   --proc 805  --gq 1 --release 2_5_3 
#./install.py --carddir Cards/tth012j_LO    --proc 805  --gq 1 --release 2_5_3 --runcms runcmsgrid_LO.sh  
#./install.py --carddir Cards/tt12j_LO      --proc 805  --gq 1 --release 2_5_3 --runcms runcmsgrid_LO.sh  

#./install.py --carddir Cards/DMSpin0_scalar_ggPhibb1j_g1   --proc 805  --gq 1 --release 2_5_1  --runcms runcmsgrid_bb.sh
#./install.py --carddir Cards/DMSpin0_pseudo_ggPhibb1j_g1   --proc 806  --gq 1 --release 2_5_1  --runcms runcmsgrid_bb.sh
#./install.py  --carddir Cards/Scalar_MonoJ_NLO_Mphi_Mchi_gSM-1p0_gDM-1p0_13TeV-madgraph     --proc 805  --gq 1  --runcms runcmsgrid_LO.sh  --release 2_4_3
#./install.py  --carddir Cards/Scalar_MonoJ_NLO_Mphi_Mchi_gSM-1p0_gDM-1p0_13TeV-madgraph     --proc 805  --gq 1  --runcms runcmsgrid_LO.sh  --release 2_5_1

#./install.py --carddir Cards/w2j      --proc 805  --gq 1 --release 2_5_3  --resubmit True
...
#./install.py --carddir Cards/ScalarSMM_MonoZLL_NLO_Mphi_Mchi_gSM-1p0_gDM-1p0_13TeV-madgraph --proc 805  --gq 0.4 --gdm 0.1 --release 2_5_3 --runcms runcmsgrid_NLO_v2.sh
./install.py --carddir Cards/ScalarSMM_MonoZ_NLO_Mphi_Mchi_gSM-1p0_gDM-1p0_13TeV-madgraph   --proc 805  --gq 0.4 --gdm 0.1 --release 2_5_3 --runcms runcmsgrid_NLO_v2.sh
./install.py --carddir Cards/ScalarSMM_MonoW_NLO_Mphi_Mchi_gSM-1p0_gDM-1p0_13TeV-madgraph   --proc 805  --gq 0.4 --gdm 0.1 --release 2_5_3 --runcms runcmsgrid_NLO_v2.sh
#./install.py --carddir Cards/ScalarSMM_TTbar_NLO_Mphi_Mchi_gSM-1p0_gDM-1p0_13TeV-madgraph   --proc 805  --gq 0.4 --release 2_5_3 --runcms runcmsgrid_NLO_v2.sh --resubmit True
#./install.py --carddir Cards/ScalarSMM_TTbar2L_NLO_Mphi_Mchi_gSM-1p0_gDM-1p0_13TeV-madgraph --proc 805  --gq 0.4 --release 2_5_3 --runcms runcmsgrid_NLO_v2.sh --resubmit True
