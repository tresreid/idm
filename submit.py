...
def replace_gridpack_generation():
    ...
    if not os.path.isfile('gridpack_generation.sh.bkp'):
        ...
        replaceWith = 'wget --no-check-certificate https://mireid.web.cern.ch/mireid/$model'
...
if __name__ == "__main__":
    ...
    #template = 'iDM_Mchi-XMASS_dMchi-XHS_mZD-MED_ctau-WIDTH'
    ...
    wchi = 1.00e-3
 #   wchi = 1.97e-17
#    wchi = 10000.23 #1000cm lifetime
#    wchi = 100002.3 #100cm lifetime
#    wchi = 1000023 #10cm lifetime
#    wchi = 10000230 #1cm lifetime
#    wchi = 100002300 #.10cm lifetime
#    ctau = 1.2e-3 #.10cm
#    ctau = 0.012 # 1 cm
#    ctau = 0.12 # 10 cm
#    ctau = 0.6 #50 cm
